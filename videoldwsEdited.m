...
% $Revision: 1.1.6.8 $  $Date: 2012/10/02 16:59:22 $
...
% System objects.
DrawPoly = 0;  % Set to 0 to draw only lines
NumRows = 0; % Number of UPPER rows in the image region to NOT process.
...
%while ~isDone(hVideoSrc) 
    ...
    YCbCr  = step(hColorConv2, RGB(NumRows+1:end,:,:));%240, :, :));
